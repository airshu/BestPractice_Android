...
public class EmulatorUtil {
    ...
    public boolean readSysProperty(Context context, EmulatorCheckCallback callback) {
        ...
        return suspectCount > 3
                || (baseBandResult.result == CheckResult.RESULT_MAYBE_EMULATOR && !hasLightSensor); //当基带和光传感器同时不存在时，判定为模拟器
    }
    ...
    private CheckResult checkFeaturesByFlavor() {
        ...
        else if (tempValue.contains("cancro")) result = CheckResult.RESULT_EMULATOR;
